...
public class Update {
    ...
    /*
    thejavapowder.Elements.Coffee Coffee = new thejavapowder.Elements.Coffee((byte) 0, (byte) 50, false, 'p', "Coffee", "Crushed Coffee Beans, First Element, Reference to Java", 0x613F37, new byte[]{3});
    thejavapowder.Elements.Wall Wall = new thejavapowder.Elements.Wall((byte) 0, (byte) 127, false, 's', "Wall", "Blocks Everything", 0x000000, new byte[]{});
    thejavapowder.Elements.Methane Methane = new thejavapowder.Elements.Methane((byte) 10, (byte) 5, false, 'g', "Methane", "Highly Flammable Gas", 0xDEDEDE, new byte[]{});
    thejavapowder.Elements.Water Water = new thejavapowder.Elements.Water((byte) 0, (byte) 30, true, 'l', "Water", "Pure H2O", 0x000000, new byte[]{});
    thejavapowder.Elements.Iron Iron = new thejavapowder.Elements.Iron((byte) 0, (byte) 127, true, 's', "Iron", "Conductor, Used to Activate Electrical Elements", 0x000000, new byte[]{});
    thejavapowder.Elements.Battery Battery = new thejavapowder.Elements.Battery((byte) 0, (byte) 127, true, 's', "Battery", "Infinite Source of Energy", 0x000000, new byte[]{});
    thejavapowder.Elements.Copper Copper = new thejavapowder.Elements.Copper((byte) 0, (byte) 127, false, 's', "Copper", "Standard Conductor", 0xE8851C, new byte[]{});
    thejavapowder.Elements.SemiConductorA SemiConductorA = new thejavapowder.Elements.SemiConductorA((byte) 0, (byte) 127, true, 's', "SemiConductorA", "Conducts only to Semi Conductor B", 0x226315, new byte[]{});
    thejavapowder.Elements.SemiConductorB SemiConductorB = new thejavapowder.Elements.SemiConductorB((byte) 0, (byte) 127, false, 's', "SemiConductorB", "Conducts only to Metal", 0x829E1C, new byte[]{});
    thejavapowder.Elements.Screen Screen = new thejavapowder.Elements.Screen((byte) 0, (byte) 127, true, 's', "Screen", "Looks different Based on Voltage", 0x000000, new byte[]{});
    thejavapowder.Elements.Resistor Resistor = new thejavapowder.Elements.Resistor((byte) 0, (byte) 30, true, 's', "Resistor", "Lowers the voltage", 0xEDED9D, new byte[]{});
    thejavapowder.Elements.RechargableBattery RechargableBattery = new thejavapowder.Elements.RechargableBattery((byte) 0, (byte) 127, true, 's', "Rechargable Battery", "Limited source of Power", 0x329E00, new byte[]{});
    thejavapowder.Elements.PowerDrainer PowerDrainer = new thejavapowder.Elements.PowerDrainer((byte) 0, (byte) 127, true, 's', "Power Drainer", "Drains the electricity", 0xBABABA, new byte[]{});
    thejavapowder.Elements.Crossing Crossing = new thejavapowder.Elements.Crossing((byte) 0, (byte) 127, false, 's', "Crossing", "Makes electricity jump over it", 0xE8851C, new byte[]{});
    thejavapowder.Elements.Switch Switch = new thejavapowder.Elements.Switch((byte) 0, (byte) 127, false, 's', "Switch", "Conducts if turned on", 0x00ED00, new byte[]{});
    */
