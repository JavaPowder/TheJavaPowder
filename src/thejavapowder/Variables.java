...
public class Variables {
    ...
    Element Elements[] = {
            ...
            new Gas(    (byte) 30, (byte) 5,   false, "Oxygen",             "Oxygen",                                           0x00D9D9, new byte[]{},   20, (byte)1),
            new Liquid( (byte) 0,  (byte) 150, true,  "Mercury",            "Mercury, heavy conductive powder",                 0x6B6B6B, new byte[]{},   20, (byte)1), //Not finished becouse the actual reactive engine don't allow that.
            new Powder( (byte) 25, (byte) 15,  false, "Gunpowder",          "Gunpowder, it burns",                              0xC7C697, new byte[]{},   20, (byte)1), //Not finished.
            new Powder( (byte) 0,  (byte) 2,   false, "Dirt",               "Dirt. Nothing Special",                            0x75471E, new byte[]{},   20, (byte)1),

    };
    // new Element(  burn,      weight, conductive, Name,                       Description,                                  colour, reactives, default temp)

    public final int NUM_ELS = 24;
