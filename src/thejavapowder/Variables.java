...
public class Variables {
    ...
    */
    ...
    static SemiConductorA SemiConductorA = new SemiConductorA((byte) 0, (byte) 127, true, 's', "SemiConductorA", "Conducts only to Semi Conductor B", 0x226315, new byte[]{}, 20);
    ...
    static Switch Switch = new Switch((byte) 0, (byte) 127, false, 's', "Switch", "Conducts if turned on", 0x00ED00, new byte[]{},20);
    static Fire Fire = new Fire((byte) 0, (byte) 5, false, 'g', "Fire", "Burns stuff", 0xDE2307, new byte[]{}, 200);
